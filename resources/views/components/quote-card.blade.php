...
<div class="rounded-2xl p-6 shadow-material flex flex-col justify-between transition-transform duration-300 hover:scale-[1.02]"
    ...
    <div class="flex justify-between items-center mt-4">
        ...
        <div class="flex gap-3">
            <button onclick="copyQuote('{{ addslashes($quote->quote) }}')" class="hover:opacity-100 opacity-80 transition">
            ...
            <button onclick="shareQuote('{{ addslashes($quote->quote) }}')" class="hover:opacity-100 opacity-80 transition">
